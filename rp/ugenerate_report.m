...
tp.Image = which('dataset_images.png'); % Optional: Add a title image if available
add(rpt, tp);
...
para3 = Paragraph([ ...
    ...
    'factorizes a data matrix A into three components: U,  (Sigma), and V^T. Mathematically:', ...
    ' A = U  V^T.']);
add(sec2, para3);
...
para4 = Paragraph([ ...
    ...
    ' (singular values) which quantify the importance of each direction, and ', ...
