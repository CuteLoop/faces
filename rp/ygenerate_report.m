...
if isfile('dataset_images.png')
    tp.Image = Image('dataset_images.png');
    tp.Image.Width = '2in';
    tp.Image.Height = '2in';
end
add(rpt, tp);
...
para_hist = Paragraph([ ...
    ...
    'This visualization reveals the number of images each person has, ranging from 1 to 60 images. ', ...
...
para_collage = Paragraph([ ...
    'To understand the overall variation within the dataset, we create a collage comprising images of ', ...
...
para_discussion = Paragraph([ ...
    'While Singular Value Decomposition (SVD) and Support Vector Machines (SVM) provide a robust framework ', ...
